 ...
 * are preserved.
 *
 * If the `sparse` property in the `options` parameter is set to true, the
 * returned list won't have its original indices preserved. Instead, the
 * undefined indices will be removed.
 *
 * @param {morePromises~list} list
